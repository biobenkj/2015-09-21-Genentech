...
[Data sheet from DR](https://www.dropbox.com/s/gyuik9xxkinaifh/00-lesson-spreadsheet.xlsx?dl=0)
...
start any cleaning, make a copy of the data and then start your cleaning. Take notes about
what you do in another tab. (short demo)

### A note on file formats

What does an excel sheet look like to my computer?

Some data requires a program to read it tractably.  Excel is one of these special programs 
that reads excel worksheets.  Here's what the spreadsheet (part of it) you worked with
looks like to your computer without Excel:
...
Dates in spreadsheets often cause problems when you're trying to interpret them or
...
We can create three new columns. 
For the first row, put Month, Day and Year in each one with:
